...
@Component({
    ...
    animations:[
        trigger('timing', [
            ...
            state('ease-out',style({opacity:0})),
            state('delay-in',style({opacity:1})),
            state('delay-out',style({opacity:0})),
            state('duration-in',style({opacity:1})),
            state('duration-out',style({opacity:0})),
            ...
            transition('*=>delay-out',[
                animate('0.2s 500ms ',style({opacity:0, transform: 'translateX(100%)'}))
            ]),
